...
export const translations = {
  ru: {
    ...
    personalityPlaceholder: "Например: Я студент, изучаю программирование. Отвечай кратко и по делу...",
  ...
  en: {
    ...
    personalityPlaceholder: "e.g.: I'm a student studying programming. Reply briefly and to the point...",
