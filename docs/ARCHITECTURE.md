...
│   │   ├── onboarding.js       # User onboarding tour
│   │   └── modules/
│   │       ├── tasks.js        # Task management
│   │       ├── calendar.js     # Calendar functionality
│   │       ├── ai-chat.js      # AI assistant chat
│   │       ├── file-upload.js  # File handling via Telegram
...
│   │   └── telegram.js         # Telegram Bot API config
│   ├── routes/
│   │   ├── auth.js             # Authentication routes
│   │   ├── tasks.js            # Task CRUD operations
│   │   ├── users.js            # User management
│   │   ├── ai.js               # AI chat functionality
│   │   ├── files.js            # File upload via Telegram
│   │   └── webhook.js          # Telegram webhook handler
│   ├── models/
│   │   ├── User.js             # User data model
│   │   ├── Task.js             # Task data model
│   │   ├── Attachment.js       # File attachment model
│   │   └── Chat.js             # AI chat history model
│   ├── services/
│   │   ├── telegram-auth.js    # Telegram authentication
│   │   ├── telegram-files.js   # File upload to Telegram
│   │   ├── perplexity-api.js   # AI service integration
│   │   ├── subscription.js     # User subscription logic
...
│   │   └── webhook.js          # Telegram signature validation
│   ├── utils/
│   │   ├── logger.js           # Logging service
│   │   ├── errorHandler.js     # Global error handling
│   │   └── circuitBreaker.js   # Circuit breaker for external APIs
│   └── database/
